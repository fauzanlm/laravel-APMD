...
@section('title', 'Tambah Laporan - Petugas')
@section('content')
    <div class="card mx-2">
        <div class="card-header">{{ __('Laporkan Masalah Yang Terjadi Di Sekitar Anda') }}</div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('petugas.laporan.add.post')}}" method="post" enctype="multipart/form-data">
                @csrf
                {{-- <input type="hidden" name="nik" value="{{ Auth::user()->nik }}"> --}}

                <div class="row mb-3">
                    <label for="nik" class="col-md-4 col-form-label text-md-start">{{ __('NIK Pelapor') }}</label>
